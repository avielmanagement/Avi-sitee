    ...
    <div className="min-h-screen bg-brand-dark overflow-x-hidden selection:bg-brand-gold selection:text-black">
      ...
      <section className="relative py-32 bg-zinc-900 border-y border-white/10">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
          ...
          <Link
            to={PageRoute.EZ_EV}
            className="inline-flex items-center gap-4 px-10 py-5 bg-cyan-500 text-black font-bold uppercase tracking-widest hover:bg-white transition-colors duration-300 shadow-xl shadow-cyan-500/20"
          >
