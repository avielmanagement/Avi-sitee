        ...
        <div className="lg:w-1/2 px-6 py-12 md:p-24 flex flex-col justify-center bg-brand-dark relative z-10 pt-24 lg:pt-24">
          <div className="max-w-lg mx-auto w-full">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button type="submit" className="w-full bg-brand-gold text-black font-bold uppercase tracking-widest py-5 hover:bg-white hover:scale-[1.02] transition-all duration-300 flex items-center justify-center gap-3 mt-6 shadow-lg shadow-brand-gold/20">
